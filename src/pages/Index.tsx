...
const AppContent: React.FC<{
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-slate-900 dark:text-white">
      <header className="bg-white dark:bg-slate-800 border-b py-4 px-6 sticky top-0 z-10">
